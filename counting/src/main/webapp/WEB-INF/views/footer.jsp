...
<footer class="page-footer">
	<div class="container">
		<div class="row">
        	...
        	<div class="col l4 offset-l2 s12">
        		...
        		<ul class="white-text">
        			<li>Pablo Macías Lopez <b>(Coordinador)</b></li>
    ...
    <div class="footer-copyright">
    	<div class="container">
        	...
        	<a class="grey-text text-lighten-4 right" href="https://github.com/AgoraUS-G2-1617/G26" target="blank">Repositorio del código en GitHub</a>
        </div>
	</div>
</footer>
